...
embeddings = CacheBackedEmbeddings.from_bytes_store( # .from_bytes_store ek class method hai jo tumhare original embedding model ke upar ek caching layer bana deta hai
    base_embeddings , 
...
# Given session ke andar kaun-kaun se papers uploaded hain, unke titles ki list return karna
